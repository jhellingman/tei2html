% Cyrillic in ad-hoc PG-DP transcription to SGML entities.
...
"[CY:"      1 "<span lang=ru style='font-size: x-large; background-color: yellow;'>"
...
"È"         p "&Ecy;"     % 0x042D    CYRILLIC CAPITAL LETTER E
"JU"        p "&YUcy;"    % 0x042E    CYRILLIC CAPITAL LETTER YU
"Ju"        p "&YUcy;"    % 0x042E    CYRILLIC CAPITAL LETTER YU
"JA"        p "&YAcy;"    % 0x042F    CYRILLIC CAPITAL LETTER YA
"Ja"        p "&YAcy;"    % 0x042F    CYRILLIC CAPITAL LETTER YA
"Ë"         p "&IOcy;"    % 0x0401    CYRILLIC CAPITAL LETTER IO
...
"è"         p "&ecy;"     % 0x044D    CYRILLIC SMALL LETTER E
"ju"        p "&yucy;"    % 0x044E    CYRILLIC SMALL LETTER YU
"ja"        p "&yacy;"    % 0x044F    CYRILLIC SMALL LETTER YA
"ë"         p "&iocy;"    % 0x0451    CYRILLIC SMALL LETTER IO
...
"<"         e "cypgdp2sgml.pat: stand alone <"
"'"         e "cypgdp2sgml.pat: stand alone '"
">"         e "cypgdp2sgml.pat: stand alone >"
"\""        e "cypgdp2sgml.pat: stand alone \""
"`"         e "cypgdp2sgml.pat: stand alone `"
"["         e "cypgdp2sgml.pat: illegal character ["
"]"         e "cypgdp2sgml.pat: illegal character ]"
...
"]"         0 ";</span>"        % closing Cyrillic early. Forgive.
