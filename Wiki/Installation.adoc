...
For generating a QR code (that contains an URL pointing at the book at Project Gutenberg), I use QRencode

On Linux, say `sudo apt install qrencode` to obtain it.
