...
You can change the scope by with notes are numbered by setting the configuration item `notes.foot.counter`. Possible values: `chapter` (default) or `text`.
